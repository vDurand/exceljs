...
var VmlAnchorXform = /*#__PURE__*/function (_BaseXform) {
  ...
  _createClass(VmlAnchorXform, [{
    ...
    key: "getDefaultRect",
    value: function getDefaultRect(model) {
      var l = model.refAddress.col;
      var lf = 6;
      var t = Math.max(model.refAddress.row - 2, 0);
      var tf = 14;
      var r = l + model.note.width;
      var rf = 2;
      var b = t + model.note.height;
      var bf = 16;
      return [l, lf, t, tf, r, rf, b, bf];
    }
  }, {
    ...
    value: function render(xmlStream, model) {
      var rect = model.anchor ? this.getAnchorRect(model.anchor) : this.getDefaultRect(model);
